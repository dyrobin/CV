...
\begin{document}
	...
	\begin{cvsection}{Employment}
            \begin{cvsubsection}{Senior/Lead Cloud Developer}{Kone}{Mar. 2021 -- Present}
                ...
                \begin{itemize}
                    \item Worked closely with stakeholders to deliver business goals and mentored junior developers
                    \item Owned/Maintained core components that ingest millions of messages per day from elevators and escalators globally as well as high-performance APIs that provide aggregated data to internal and external customers
                    \item Improved architecture and implementation consistently to have better performance, reliability or cost
                    \item Appraised as highest grade in 2022 \& 2023 performance appraisal
